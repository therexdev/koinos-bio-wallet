...
const IDS = {
  'app.js (existing)': [
    ...
    'btn-create-account', 'connection-status', 'btn-unlock-existing', 'btn-open-recover', 'btn-recover-back', 'btn-recover', 'addr',
  ...
  'fund.js': [
    ...
    'fund-sol-block', 'fund-sol-qr', 'fund-sol-addr', 'fund-sol-note', 'stat-sol-row', 'stat-sol', 'stat-bridge-sub',
  ],
  'ui.js (shell)': [
